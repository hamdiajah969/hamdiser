    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <form action="{{ route('operator.ekstrakulikuler.update', Crypt::encrypt($ekstrakulikuler->id_ekskul)) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('operator.ekstrakulikuler.index') }}" class="btn text-white fw-bold" style="background: #e0a000;">Kembali</a>
