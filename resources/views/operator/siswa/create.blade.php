                ...
                <div class="card-body">
                    <form action="{{ route('operator.siswa.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tahun_masuk') is-invalid @enderror" id="tahun_masuk" name="tahun_masuk" value="{{ old('tahun_masuk') }}" min="1900" max="{{ date('Y') + 1 }}">
                            @error('tahun_masuk')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('operator.siswa.index') }}" class="btn text-white fw-bold" style="background: #e0a000;">Kembali</a>
